...
def append_prmt(tostr, umacrs, excl_umc=None):
    ...
    prms_l +=([]
            ...
            +[_('{Lexer}\tFile\'s lexer')]
            +[_('{LexerAtCaret}\tLexer at first caret')]
            +[_('{CurrentLine}\tText of current line')]
            +[_('{CurrentLineNum}\tNumber of current line (1-based)')]
            +[_('{CurrentLineNum0}\tNumber of current line (0-based)')]
            +[_('{CurrentColumnNum}\tNumber of current column (1-based)')]
            +[_('{CurrentColumnNum0}\tNumber of current column (0-based)')]
            +[_('{SelectedText}\tCurrently selected text')]
            +[_('{CurrentWord}\tText of word under first caret')]
            +[_('{Interactive}\tText, will be asked at each running')]
            +[_('{InteractiveFile}\tFile name, will be asked at each running')]
